            ...
            <div class="app-header header sticky">
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <!-- sidebar-toggle-->
                        <a class="logo-horizontal " href="index.blade.php">
            ...
            <div class="sticky">
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="index.blade.php">
                            <img src="../assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="index.blade.php"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Dashboard</span></a>
                            </li>
                            <li class="sub-category">
                                <h3>UI Kit</h3>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="users-list.blade.php" class="slide-item"> User List</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="profile.blade.php" class="slide-item"> Profile</a></li>
                                    <li><a href="edit-profile.blade.php" class="slide-item"> Edit Profile</a></li>
                                    ...
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            ...
                                            <li><a href="blog-post.blade.php" class="sub-slide-item"> Blog Post</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="products.blade.php" class="slide-item"> Shop</a></li>
                                    <li><a href="product-details.blade.php" class="slide-item"> Product Details</a></li>
                                    <li><a href="cart.html" class="slide-item"> Shopping Cart</a></li>
                                    <li><a href="add-product.blade.php" class="slide-item"> Add Product</a></li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="login.blade.php" class="slide-item"> Login</a></li>
                                    <li><a href="register.html" class="slide-item"> Register</a></li>
                                    <li><a href="forgot-password.blade.php" class="slide-item"> Forgot Password</a></li>
                                    ...
                                    <li class="sub-slide">
                                        ...
                                        <ul class="sub-slide-menu">
                                            ...
                                            <li><a href="errors/404.blade.php" class="sub-slide-item"> 404</a></li>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                <div class="card">
                                    <img class="card-img-top " src="../assets/images/media/blog11.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <div class="d-md-flex">
                                            ...
                                            <a href="profile.blade.php" class="d-flex mb-2"><i class="fe fe-user fs-16 me-1 p-3 bg-primary-transparent text-primary bradius"></i>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="media mb-5 overflow-visible d-block d-sm-flex">
                                            <div class="me-3 mb-2">
                                                <a href="profile.blade.php"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/5.jpg"> </a>
                                            </div>
                                            <div class="media-body overflow-visible">
                                                ...
                                                <div class="media mb-5 overflow-visible">
                                                    <div class="me-3">
                                                        <a href="profile.blade.php"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/2.jpg"> </a>
                                                    </div>
                                        ...
                                        <div class="media mb-5 overflow-visible">
                                            <div class="me-3">
                                                <a href="profile.blade.php"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/15.jpg"> </a>
                                            </div>
                                            <div class="media-body overflow-visible">
                                                <div class="border mb-5 p-4 br-5">
                                                    <nav class="nav float-end">
                                                ...
                                                <div class="media mb-5 overflow-visible d-block d-sm-flex">
                                                    ...
                                                    <div class="media-body overflow-visible">
                                                        ...
                                                        <div class="media overflow-visible">
                                                            <div class="me-3">
                                                                <a href="profile.blade.php"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/9.jpg"> </a>
                                                            </div>
                                                            <div class="media-body border p-4 overflow-visible br-5">
                                                                <nav class="nav float-end">
                                                                    <div class="dropdown">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal  m-t-20" action="index.blade.php">
                                    ...
                                    <div class="card-body">
                                        <div class="">
                                            <div class="d-flex overflow-visible">
                                                <img class="avatar bradius avatar-xl me-3" src="../assets/images/users/1.jpg" alt="avatar-img">
                                                <div class="media-body valign-middle">
                                                    <a href="profile.blade.php" class="fw-semibold text-dark">Simon Sais</a>
                                            ...
                                            <div class="d-flex overflow-visible mt-5">
                                                <img class="avatar bradius avatar-xl me-3" src="../assets/images/users/3.jpg" alt="avatar-img">
                                                <div class="media-body valign-middle">
                                                    <a href="profile.blade.php" class="fw-semibold text-dark">Cherry Blossom</a>
                                                    <p class="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                                                </div>
                                            </div>
                                            <div class="d-flex overflow-visible mt-5">
                                                <img class="avatar bradius avatar-xl me-3" src="../assets/images/users/5.jpg" alt="avatar-img">
                                                <div class="media-body valign-middle">
                                                    <a href="profile.blade.php" class="fw-semibold text-dark">Ivan Notheridiya</a>
                                                    <p class="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                                                </div>
                                            </div>
                                            <div class="d-flex overflow-visible mt-5">
                                                <img class="avatar bradius avatar-xl me-3" src="../assets/images/users/15.jpg" alt="avatar-img">
                                                <div class="media-body valign-middle">
                                                    <a href="profile.blade.php" class="fw-semibold text-dark">Manny Jah</a>
                                                    <p class="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                                                </div>
                                            </div>
                                        </div>
